...
function ChatFormName({handleInputChange, onClick}) {
  return (
    <ChatForm title="¿Cual es tu nombre?">
      <Input name="firstName" type="text" placeholder="Nombre (requerido)" onChange={handleInputChange} />
      <Input name="middleName" type="text" placeholder="Segundo nombre" onChange={handleInputChange} />
      <Input name="fatherLastName" type="text" placeholder="Apellido paterno (requerido)" onChange={handleInputChange} />
